...
class TrainingPage extends React.Component {
    ...
    render() {
        ...
        const list = groups.models && groups.models.map((obj) =>
            <li className={this.state.active == obj.id ? 'active': ''} key={obj.id} onClick={(e) => this.modelClick(e, obj.id)}><Typography variant="subtitle2" gutterBottom>{obj.name}</Typography></li>
        );
                        ...
                        <Grid item xs={9}>
                            <Paper className={classes.paper}>
                                <Grid container justify="center">
                                    <Grid item xs={5}>
                                        ...
                                        <br/>
                                        <Typography variant="h6" gutterBottom>Target column</Typography>
                                        ...
                                        <Grid container justify="center">
                                            <Grid item xs={6}>
                                                ...
                                                <Typography variant="body2" gutterBottom>{groups.training_detail && groups.training_detail.length > 0 && groups.training_detail[0].time_yariable_d.column_name}</Typography>
                                                <br/>
                                                <Typography variant="h6" gutterBottom>Problem type</Typography>
                                            ...
                                            <Grid item xs={6}>
                                                <Typography variant="h6" gutterBottom>Rows</Typography>
                                        ...
                                        <Grid container justify="center">
                                            <Grid item xs={7}>
                                                <CircularProgressbar
                                                    ...
                                                    styles={{
                                                        path: { stroke: `#4caf50` },
                                                        text: { fill: '#4caf50', fontSize: '16px', fontFamily: 'roboto' },
                                                    }}
                                                />
                                            </Grid>
                            ...
                            <Paper className={classes.paper}>
                                ...
                                <Grid container>
                                    ...
                                    </Grid>
                                    {
                                        ...
                                        <Grid item sm={6} style={{textAlign: 'right'}}>
                                            <Button onClick={this.deployModel} size="small" color="primary">
                                                Deploy model
                                            </Button>
                                        </Grid>
                                    }
                                ...
                                >
                                    ...
                                    <Tab label="Loss vs Time" />
                                    <Tab label="Actual vs prediction" />
                                </Tabs>
                                        ...
                                        <table border="0" width="75%">
                                            {
                                                groups.accuracy.map((obj) =>
                                                    <tr key={obj.metric.id}>
                                                        <td><Typography variant="subtitle2" gutterBottom>{obj.metric.name}</Typography></td>
                                                        <td><Typography variant="body2" gutterBottom>{parseFloat(obj.value).toFixed(2)}</Typography></td>
                                                    </tr>
                                                )
                                            }
